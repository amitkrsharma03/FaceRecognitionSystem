...
def change_pass():
    ...
    lbl4 = tk.Label(master,text='Enter Old Password',bg='#f5f5f5',fg="#333",font=('Helvetica', 12, 'bold'))
    lbl4.place(x=10,y=10)
    global old
    old=tk.Entry(master,width=25 ,fg="#333",relief='flat',font=('Helvetica', 12),show='*', bg="#e0e0e0")
    old.place(x=180,y=10)
    lbl5 = tk.Label(master, text='Enter New Password', bg='#f5f5f5',fg="#333", font=('Helvetica', 12, 'bold'))
    lbl5.place(x=10, y=45)
    global new
    new = tk.Entry(master, width=25, fg="#333",relief='flat', font=('Helvetica', 12),show='*', bg="#e0e0e0")
    new.place(x=180, y=45)
    lbl6 = tk.Label(master, text='Confirm New Password', bg='#f5f5f5',fg="#333", font=('Helvetica', 12, 'bold'))
    lbl6.place(x=10, y=80)
    global nnew
    nnew = tk.Entry(master, width=25, fg="#333", relief='flat',font=('Helvetica', 12),show='*', bg="#e0e0e0")
    nnew.place(x=180, y=80)
    cancel=tk.Button(master,text="Cancel", command=master.destroy ,fg="white" ,bg="#ff4d4d" ,height=1,width=25 ,font=('Helvetica', 10, 'bold'))
    cancel.place(x=200, y=120)
    save1 = tk.Button(master, text="Save", command=save_pass, fg="white", bg="#4CAF50", height=1,width=25, font=('Helvetica', 10, 'bold'))
    save1.place(x=10, y=120)
    master.mainloop()
...
message3 = tk.Label(header_frame, text="Face Recognition Attendance System", fg="white", bg="#2c3e50",
                    font=('Helvetica', 24, 'bold'))
message3.place(relx=0.02, rely=0.25)

datef = tk.Label(header_frame, text=day + "-" + mont[month] + "-" + year, fg="#ecf0f1", bg="#2c3e50",
                 font=('Helvetica', 14, 'bold'))
datef.place(relx=0.82, rely=0.15)

clock = tk.Label(header_frame, fg="#ecf0f1", bg="#2c3e50", font=('Helvetica', 14, 'bold'))
clock.place(relx=0.90, rely=0.55)
tick()

# Left Frame (For Already Registered)
frame1 = tk.Frame(window, bg="white", bd=1, relief="solid")
frame1.place(relx=0.05, rely=0.15, relwidth=0.43, relheight=0.80)

head1 = tk.Label(frame1, text="For Already Registered", fg="#333", bg="#4CAF50",
                 font=('Helvetica', 14, 'bold'), pady=10)
head1.place(relx=0, rely=0, relwidth=1)

lbl3 = tk.Label(frame1, text="Attendance Records", fg="#333", bg="white",
                font=('Helvetica', 14, 'bold'))
lbl3.place(relx=0.05, rely=0.08)
...
tv.place(relx=0.05, rely=0.15, relwidth=0.9, relheight=0.55)
tv.heading('#0', text='ID')
tv.heading('name', text='NAME')
tv.heading('date', text='DATE')
tv.heading('time', text='TIME')
...
scroll = ttk.Scrollbar(frame1, orient='vertical', command=tv.yview)
scroll.place(relx=0.95, rely=0.15, relheight=0.55)
tv.configure(yscrollcommand=scroll.set)

trackImg = tk.Button(frame1, text="Take Attendance", command=TrackImages, fg="white", bg="#4CAF50",
                     font=('Helvetica', 12, 'bold'), relief="flat", pady=10)
trackImg.place(relx=0.05, rely=0.75, relwidth=0.9)

quitWindow = tk.Button(frame1, text="Quit", command=window.destroy, fg="white", bg="#ff4d4d",
                       font=('Helvetica', 12, 'bold'), relief="flat", pady=10)
quitWindow.place(relx=0.05, rely=0.85, relwidth=0.9)

# Right Frame (For New Registrations)
frame2 = tk.Frame(window, bg="white", bd=1, relief="solid")
frame2.place(relx=0.52, rely=0.15, relwidth=0.43, relheight=0.80)

head2 = tk.Label(frame2, text="For New Registrations", fg="#333", bg="#4CAF50",
                 font=('Helvetica', 14, 'bold'), pady=10)
head2.place(relx=0, rely=0, relwidth=1)

lbl = tk.Label(frame2, text="Enter ID", fg="#333", bg="white", font=('Helvetica', 12, 'bold'))
lbl.place(relx=0.05, rely=0.08)

txt = tk.Entry(frame2, width=25, fg="#333", font=('Helvetica', 12), relief="flat", bg="#e0e0e0")
txt.place(relx=0.05, rely=0.13, relwidth=0.65)

clearButton = tk.Button(frame2, text="Clear", command=clear, fg="white", bg="#ff9800",
                        font=('Helvetica', 10, 'bold'), relief="flat")
clearButton.place(relx=0.75, rely=0.13, relwidth=0.2)

lbl2 = tk.Label(frame2, text="Enter Name", fg="#333", bg="white", font=('Helvetica', 12, 'bold'))
lbl2.place(relx=0.05, rely=0.23)

txt2 = tk.Entry(frame2, width=25, fg="#333", font=('Helvetica', 12), relief="flat", bg="#e0e0e0")
txt2.place(relx=0.05, rely=0.28, relwidth=0.65)

clearButton2 = tk.Button(frame2, text="Clear", command=clear2, fg="white", bg="#ff9800",
                         font=('Helvetica', 10, 'bold'), relief="flat")
clearButton2.place(relx=0.75, rely=0.28, relwidth=0.2)

message1 = tk.Label(frame2, text="1) Take Images  →  2) Save Profile", bg="white", fg="#666",
                    font=('Helvetica', 12), pady=10)
message1.place(relx=0.05, rely=0.38, relwidth=0.9)

takeImg = tk.Button(frame2, text="Take Images", command=TakeImages, fg="white", bg="#2196F3",
                    font=('Helvetica', 12, 'bold'), relief="flat", pady=10)
takeImg.place(relx=0.05, rely=0.48, relwidth=0.9)

trainImg = tk.Button(frame2, text="Save Profile", command=psw, fg="white", bg="#2196F3",
                     font=('Helvetica', 12, 'bold'), relief="flat", pady=10)
trainImg.place(relx=0.05, rely=0.58, relwidth=0.9)

message = tk.Label(frame2, text="", bg="white", fg="#333", font=('Helvetica', 12, 'bold'))
message.place(relx=0.05, rely=0.85, relwidth=0.9)
